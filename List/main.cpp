...
/*   Updated: 2021/06/04 17:48:58 by mskinner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	ft::list<float>		l5;
	std::list<float>	sl5;
	ft::list<std::string> l99;
	std::list<std::string> sl99;
	...
	std::cout << "list 6 size: " << l99.size() << std::endl;
	...
	std::cout << "is list 6 empty: " << l99.empty() << std::endl;
	...
	std::cout << "maximal list 6 size: " << l99.max_size() << " vs std: " << sl99.max_size() << std::endl;
	...
	sl10.push_back(77);
	printContainer(sl10);
	l10.insert(++(++(++l10.begin())), l10.begin(), ++(++l10.begin()));
	std::cout << "ft_ after: ";
	printContainer(l10);
	...
	tmp.splice(tmp.begin(), splc, ++(++splcit), splc.end());
	std::cout << "After splice splc: ";
	printContainer(splc);
	std::cout << "After splice tmp_: ";
	printContainer(tmp);
	...
	splcit = tmp.begin();
	splc.splice(splc.end(), tmp, ++(++(++splcit)));
	std::cout << "After splice splc: ";
	printContainer(splc);
	std::cout << "After splice tmp_: ";
	printContainer(tmp);
	...
	std::cout << std::endl << "list COMPARISON TESTS >>>" << std::endl;
	std::cout << "std lists for comparison: " << std::endl;
	printContainer(sl13);
	printContainer(csl13);
	std::cout << "std: equal: " << (sl13 == csl13) << ", not equal: " << (sl13 != csl13);
	std::cout << ", >: " << (sl13 > csl13) << ", >=: " << (sl13 >= csl13) << ", <: " << (sl13 < csl13);
	std::cout << ", <=: " << (sl13 <= csl13) << std::endl;
	std::cout << "ft lists for comparison: " << std::endl;
	printContainer(l13);
	printContainer(cl13);
	std::cout << "ft_: equal: " << (l13 == cl13) << ", not equal: " << (l13 != cl13);
	std::cout << ", >: " << (l13 > cl13) << ", >=: " << (l13 >= cl13) << ", <: " << (l13 < cl13);
	std::cout << ", <=: " << (l13 <= cl13) << std::endl;

	std::cout << std::endl << "std lists for comparison: " << std::endl;
	printContainer(sl10);
	printContainer(sl13);
	std::cout << "std: equal: " << (sl10 == sl13) << ", not equal: " << (sl10 != sl13);
	std::cout << ", >: " << (sl10 > sl13) << ", >=: " << (sl10 >= sl13) << ", <: " << (sl10 < sl13);
	std::cout << ", <=: " << (sl10 <= sl13) << std::endl;
	std::cout << "ft lists for comparison: " << std::endl;	
	printContainer(l10);
	printContainer(l13);
	std::cout << "ft_: equal: " << (l10 == l13) << ", not equal: " << (l10 != l13);
	std::cout << ", >: " << (l10 > l13) << ", >=: " << (l10 >= l13) << ", <: " << (l10 < l13);
	std::cout << ", <=: " << (l10 <= l13) << std::endl;
};
